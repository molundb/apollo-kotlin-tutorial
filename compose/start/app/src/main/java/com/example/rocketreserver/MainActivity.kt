...
import com.example.rocketreserver.TripsBookedSubscription.Data
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            RocketReserverTheme {
                ...
                val tripBookedResponse: ApolloResponse<Data>? by tripBookedFlow.collectAsState(initial = null)
